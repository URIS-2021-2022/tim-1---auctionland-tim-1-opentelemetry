...
{
    public class DocumentMsContext : DbContext
    {
        private readonly IConfiguration configuration;

        public DocumentMsContext(DbContextOptions<DocumentMsContext> options, IConfiguration configuration) : base(options)
        {
        ...
        {
            optionsBuilder.UseSqlServer(configuration.GetConnectionString("DocumentDataBase"));
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<LeaseAgreement>().HasData(new LeaseAgreement
            {
