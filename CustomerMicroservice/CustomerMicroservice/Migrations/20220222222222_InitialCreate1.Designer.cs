...
namespace CustomerMicroservice.Migrations
{
    ...
    [Migration("20220222222222_InitialCreate")]
            ...
            modelBuilder.Entity("CustomerMicroservice.Entities.AuthorizedPerson", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublicBiddingID = new Guid("6b411c13-a186-48f7-78ad-57896c3944b1")
                        },
                        new
                        {
                            ...
                            PublicBiddingID = new Guid("2b411c13-a186-28f7-78bd-57296c3974b0")
                        });
                });
            ...
            modelBuilder.Entity("CustomerMicroservice.Entities.LegallyPerson", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Priority = "Visok",
                            PublicBiddingID = new Guid("5a411c13-a146-48f7-78bd-57896c3974b3"),
                            RealizedArea = "38ha",
            ...
            modelBuilder.Entity("CustomerMicroservice.Entities.PhysicalPerson", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Priority = "Nizak",
                            PublicBiddingID = new Guid("3b411c13-a186-48f7-78bd-57596c3974b3"),
                            RealizedArea = "10ha",
